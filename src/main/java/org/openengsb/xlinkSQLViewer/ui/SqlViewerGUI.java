...
public class SqlViewerGUI extends JFrame implements ClipboardOwner {
    ...
    /**
     * Returns the defined description of the programs language or, if not found, an arbitary one.
     */
    ...
    /**
     * MouseAdapter to handle the selection of a ListElement. Manages the PopupMenu and the Doubleclick to open the
     * Statement's Details
     */
