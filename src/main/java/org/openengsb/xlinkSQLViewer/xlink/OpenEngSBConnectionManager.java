...
public class OpenEngSBConnectionManager {
	...
	/**
	 * HostIP of the local system, used to identify the Host during an XLink
	 * call
	 */
	...
	/***
	 * Creates/Registers the connector at the OpenEngSB and registers the
	 * connector to XLink
	 * 
	...
	/*
	 * private String getHostName(){ String hostname = null; try { InetAddress
	 * addr = InetAddress.getLocalHost(); hostname = addr.getHostName();
	 * logger.log(Level.INFO,"Host "+hostname); } catch (UnknownHostException e)
	 * { } return hostname; }
	 */
